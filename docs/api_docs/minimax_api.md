  ...
  schemas:
    GenerateMusicReq:
      ...
      properties:
        model:
          type: string
          description: 'The model name. Options: `music-2.5`.'
          enum:
            - music-2.5
        prompt:
          type: string
          description: |-
            ...
            <br>
            Note:
            - For `music-2.5`: Optional. Length: 0–2000 characters.
            - For non-`music-2.5` models: Required. Length: 10–2000 characters.
          maxLength: 2000
        lyrics:
          type: string
          description: >-
            Lyrics of the song. Use `\n` to separate lines. You may add
            structure tags like `[Intro]`, `[Verse]`, `[Pre Chorus]`,
            `[Chorus]`, `[Interlude]`, `[Bridge]`, `[Outro]`, `[Post Chorus]`,
            `[Transition]`, `[Break]`, `[Hook]`, `[Build Up]`, `[Inst]`,
            `[Solo]` to enhance the arrangement.

            <br>

            Length:

            - For `music-2.5`: 1–3500 characters.

            - For non-`music-2.5` models: 10–3500 characters.
          minLength: 1
          maxLength: 3500
        stream:
          type: boolean
